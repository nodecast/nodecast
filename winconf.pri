...
INCLUDEPATH += $$quote(C:/nodecast/install/zlib/include)

INCLUDEPATH += $$quote(C:/nodecast/install/openssl/include)
INCLUDEPATH += $$quote(C:/nodecast/install/qxmpp/include)


#Point this to the boost lib folder
LIBS += $$quote(-LC:/nodecast/install/boost/lib)
#Point this to the libtorrent lib folder
LIBS += $$quote(-LC:/nodecast/install/libtorrent/lib)
#Point this to the zlib lib folder
LIBS += $$quote(-LC:/nodecast/install/zlib/lib)
LIBS += $$quote(-LC:/nodecast/install/openssl/lib)
LIBS += $$quote(-LC:/nodecast/install/qxmpp/lib)
