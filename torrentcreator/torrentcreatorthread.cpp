...
void TorrentCreatorThread::create(QString _input_path, QString _save_path, QStringList _trackers, QStringList _url_seeds, int _piece_size)
{
...
void TorrentCreatorThread::run() {
  ...
  QString creator_str("nodecast " VERSION);
  try {
    file_storage fs;
    ...
    qDebug() << "PARENT PATH : " << parent_path << " INPUT PATH : " << input_path;
