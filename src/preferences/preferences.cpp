...
#ifndef Q_OS_MAC
    QIniSettings *settings_new = new QIniSettings("pcode", "nodecast");
...
// Nodecast
QString Preferences::getVideoPlayer() const {
  QString player = value(QString::fromUtf8("Preferences/Video/Player")).toString();
  if (!player.isEmpty())
    return player;
#if defined(Q_OS_MAC)
  return "VLC.app";
...
void Preferences::setVideoPlayer(const QString &player) {
  setValue(QString::fromUtf8("Preferences/Video/Player"), player);
}

QHash<QString, QString> Preferences::getNodecastAccount() const {
...
void Preferences::setNodecastAccount(const QHash<QString, QString> &account) {
...
QString Preferences::getNodecastNickname() const {
...
QString Preferences::getNodecastLogin() const {
    QString login = value(QString::fromUtf8("Preferences/Nodecast/Login")).toString();
